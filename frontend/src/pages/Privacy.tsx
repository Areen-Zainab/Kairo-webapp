        ...
        <div className="bg-slate-900/70 backdrop-blur-xl rounded-3xl border border-white/10 p-8 md:p-12">
          ...
          <div className="space-y-6 text-slate-200/90 leading-relaxed">
            <p className="text-slate-300">
              This Privacy Policy explains, at a high level, how Kairo may collect and use information. This page is provided
              as a minimal, informational placeholder.
            </p>
            ...
            <section className="space-y-2">
              ...
              <ul className="list-disc pl-6 text-slate-300 space-y-1">
                ...
                <li>Meeting data you provide (audio/video files, transcripts, and metadata)</li>
                <li>Usage and diagnostics data to operate and improve the service</li>
              </ul>
            </section>
            ...
            <section className="space-y-2">
              ...
              <ul className="list-disc pl-6 text-slate-300 space-y-1">
                <li>Provide core product functionality (transcription, summaries, memory search)</li>
            ...
            <section className="space-y-2">
              ...
              <p className="text-slate-300">
                You can manage your account and certain settings inside the app. For legal text related to usage, see{" "}
                <a href="/terms" className="text-purple-300 hover:text-purple-200 underline">
                  Terms of Service
                </a>
                .
              </p>

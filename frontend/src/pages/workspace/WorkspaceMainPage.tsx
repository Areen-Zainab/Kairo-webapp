...
import { Video, CheckSquare, TrendingUp, Clock, Users, Calendar, ArrowUpRight, Play, MoreVertical, MessageSquare, FileText, Brain, Network, Filter, Download } from 'lucide-react';
      ...
      <div className="mb-8 flex items-center justify-between">
        <div>
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <h1 className="text-3xl font-bold text-white">Product Team Alpha</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {stats.map((stat) => {
          ...
          return (
            <div
              key={stat.id}
              className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-2xl p-6 hover:border-slate-600 transition-all duration-300 hover:shadow-xl hover:shadow-purple-500/10 group cursor-pointer"
            >
        ...
        <div className="lg:col-span-2 bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-2xl p-6">
          ...
          <div className="space-y-4">
            {upcomingMeetings.map((meeting) => (
              <div
                key={meeting.id}
                className="bg-slate-900/50 border border-slate-700 rounded-xl p-4 hover:border-purple-500/50 transition-all duration-300 group cursor-pointer"
              >

      ...
      {columns.map((column) => {
        ...
        return (
          <div
            key={column.id}
            className={`
              flex-shrink-0 w-80 bg-slate-50 dark:bg-slate-800/50 rounded-lg border border-slate-200 dark:border-slate-700
          ...
          >
            ...
            {dragOverColumn === column.id && (
              <div className="mx-4 mb-4 border-2 border-dashed border-blue-400 rounded-lg h-16 flex items-center justify-center bg-blue-50/50 dark:bg-blue-900/20">

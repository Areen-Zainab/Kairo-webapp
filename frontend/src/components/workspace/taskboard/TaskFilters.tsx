...
const TaskFilters: React.FC<TaskFiltersProps> = ({
  ...
  return (
    <div className="bg-white dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700 p-3 sm:p-4 mb-6">
      {/* Header */}
      <div className="flex items-center justify-between mb-3 sm:mb-4">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            <svg
              className={`w-3.5 h-3.5 sm:w-4 sm:h-4 transition-transform ${isExpanded ? 'rotate-180' : ''}`}
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
      ...
      <div className="mb-3 sm:mb-4">
        ...
        <input
          ...
          className="w-full px-2.5 sm:px-3 py-1.5 sm:py-2 text-sm border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-700 text-slate-900 dark:text-white placeholder-slate-500 dark:placeholder-slate-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
        />
      </div>
        ...
        <div className="space-y-3 sm:space-y-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-2.5 sm:px-3 py-1.5 sm:py-2 text-sm border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-700 text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            >
            ...
            <div className="flex flex-wrap gap-1.5 sm:gap-2">
              {priorityOptions.map((priority) => (
                <button
                  ...
                  className={`
                    px-2 sm:px-3 py-1 rounded-full text-[10px] sm:text-xs font-medium transition-colors
